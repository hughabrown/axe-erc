...
import {
  ...
  validateFindings,
  generateFinalReport,
  OutlineStructure as ImportedOutlineStructure,
  SectionFindings,
  ValidationReport
} from '../synthesis/multi-pass-synthesis';

// Re-export OutlineStructure for external use
export type { OutlineStructure } from '../synthesis/multi-pass-synthesis';
...
// Re-export OutlineSection for backwards compatibility
...
export type SearchEvent = 
  ...
  | { type: 'outline-generated'; outline: ImportedOutlineStructure }
...
const SearchStateAnnotation = Annotation.Root({
  ...
  multiPassState: Annotation<{
    currentPass: 1 | 2 | 3 | 4;
    outline: ImportedOutlineStructure | null;
